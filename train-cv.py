...
for runid in range(1, 6):
	...
	file_logger.log('Run model {} times'.format(runid))
	# model
	...
	for epoch in range(1, opt['num_epoch']+1):
		...
		file_logger.log("Epoch {}\t{:.6f}\t".format(epoch, train_loss, dev_loss))
		file_logger.log("Dev result: {:.6f}\t{:.6f}\t{:.6f}".format(dev_p, dev_r, dev_f1))
		...
		print("test_f1 = {:.4f}".format(test_f1))
		file_logger.log("Test result: {:.6f}\t{:.6f}\t{:.6f}".format(test_p, test_r, test_f1))

		# save
		model_file = model_save_dir + '/checkpoint_epoch_{}.pt'.format(epoch)
		model.save(model_file, epoch)
		if epoch == 1 or dev_f1 > max(dev_f1_history):
			result_on_best_dev_f1 = (dev_p, dev_r, dev_f1, test_p, test_r, test_f1)
	...
	dev_p, dev_r, dev_f1, test_p, test_r, test_f1 = result_on_best_dev_f1
	file_logger.log("Best dev result: {:.6f}\t{:.6f}\t{:.6f}".format(dev_p, dev_r, dev_f1))
	file_logger.log("Test result on best dev f1: {:.6f}\t{:.6f}\t{:.6f}".format(test_p, test_r, test_f1))
