...
class DataLoader(object):
	...
	def preprocess(self, data, vocab, opt):
		...
		for d in data:
			...
			if len(ner) != len(tokens) or len(tokens) > constant.MAX_LEN:
				continue
			...
			if d['relation'] not in constant.LABEL_TO_ID:
				continue
			if d['relation'] not in constant.LABEL_TO_ID:
				relcnt = len(constant.LABEL_TO_ID)
				constant.LABEL_TO_ID[d['relation']] = relcnt
